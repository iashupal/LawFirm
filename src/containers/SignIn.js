...
class SignIn extends React.Component {
  ...
  render() {
    ...
    const {
      signupUserID, // 일반 사용자의 최초 로그인 용 링크
      signupEmailAdmin, // 관리자의 최초 로그인 용 링크
    ...
    return (
      ...
      <div className="app-login-container d-flex justify-content-center align-items-center animated slideInUpTiny animation-duration-3">
        ...
        {!findPwdID && !pwdReset && !pwdResetErrorQ && (
          <div className="app-login-main-content animated fadeInUp">
            <div className="app-logo-content d-flex align-items-center justify-content-center">
              <img src="assets/images/logo/Law.ai_white.png" style={{ width: '200px' }} alt="logo" title="logo" />
              {/* <h2 className="text-white font-weight-bold align-text-bottom" style={{ fontSize: 32 }}>HI-LAW</h2> */}
            </div>
        ...
        <UserInfo open={!!signupUserID} initUserID={signupUserID} />
...
const mapStateToProps = ({ auth, routing, common }) => {
  const {
    loader,
    alertMessage,
    showMessage,
