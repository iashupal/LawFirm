    ...
    return (
      <div className="tabone">
                    ...
                    <div className="form">
                      ...
                      <div className="wrapper-checkbox">
                        ...
                        <div className="contain-cal-btn">
                          <button
                            type="button"
                            className="btn btnStyle  btn-color"
                          >
                            CalBtn
                          </button>
        ...
        <div className="form-submisn-btns">
          <Button
            className="btn btn-primary left btnStyle clr1"
            variant="contained"
          >
            Button2
          </Button>
          <Button
            className="btn left btnStyle accord3-btn-clr"
            variant="contained"
          >
            Button2
          </Button>
          <Button
            className="btn btn-danger right btnStyle clr3"
            variant="contained"
          >
            Button3
          </Button>
