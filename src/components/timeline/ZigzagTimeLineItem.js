    ...
    <div className={`timeline-item ${styleName}`}>
      <div className="timeline-badge timeline-img">
        {styleName.includes('timeline-inverted') ? (
          <img className="size-60" src="assets/images/pentagon_1.png" alt="Pentagon" title="Pentagon" />
        ) : (
          <img className="size-60" src="assets/images/pentagon.png" alt="Pentagon" title="Pentagon" />
        )}
      </div>
