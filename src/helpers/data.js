    ...
    data: [
      {
        ...
        data: [
          ...
          { link: '/app/elastic_search', name: 'pages.elasticSearch' },
          { link: '/app/dashboard', name: 'pages.dashboard', multiCompanyHide: true },
          {
          ...
          { link: '/app/qna', name: 'pages.qna', multiCompanyHide: true },
      ...
      },
      {
        ...
        data: [
          ...
          },
          {
            ...
            roleList: ['Role.Legal.SuperAdmin', 'Role.Legal.ContractAdmin'],
            multiCompanyHide: true,
          },
        ],
      },
