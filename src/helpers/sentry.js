...
*/
const install = () => {
  if (__BUILD_VERSION__ !== undefined && __BUILD_VERSION__ !== 'local') {
    const sentry_server = 'https://3c2916a56a114fcead7d8169c02f3201@sentry.law365ai.com/3';
    ...
    console.log('Sentry not installed, because it is local.');
  }
};
