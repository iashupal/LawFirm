...
import { FontSizes, FontWeights, HighContrastSelector, getGlobalClassNames, normalize, HighContrastSelectorWhite, getScreenSelector, ScreenWidthMinMedium } from '../../Styling';
    ...
    return {
        ...
        title: [
            ...
            disabled && {
                ...
                color: semanticColors.disabledText,
                cursor: 'default',
                selectors: (_d = {}, _d[HighContrastSelector] = { border: '1px solid GrayText', color: 'GrayText' }, _d)
            }
        ],
        caretDownWrapper: [
