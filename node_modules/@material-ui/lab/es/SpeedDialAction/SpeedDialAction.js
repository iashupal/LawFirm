  ...
  render() {
    const _this$props = this.props,
      ...
      tooltipOpen
          ...
          other = _objectWithoutProperties(_this$props, ["ButtonProps", "classes", "className", "delay", "icon", "id", "onClick", "onKeyDown", "open", "tooltipTitle", "tooltipPlacement", "tooltipOpen"]);
    ...
    }, other), React.createElement(Button, _extends({
      variant: "fab",
      mini: true,
