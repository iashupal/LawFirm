  ...
  (0, _createClass2.default)(SpeedDialAction, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          other = (0, _objectWithoutProperties2.default)(_this$props, ["ButtonProps", "classes", "className", "delay", "icon", "id", "onClick", "onKeyDown", "open", "tooltipTitle", "tooltipPlacement", "tooltipOpen"]);
      var clickProp = {
        onClick: onClick
      };
